...
swig/python/sdbf_wrap.o: sdbf.i $(LIBSDBF)
	swig3.0 -c++ -python swig/python/sdbf.i
	g++ -std=c++0x -fPIC -c swig/python/sdbf_wrap.cxx -o swig/python/sdbf_wrap.o -I/usr/include/python3.4

swig/python/_sdbf_class.so: swig/python/sdbf_wrap.o $(LIBSDBF)
	g++ -shared swig/python/sdbf_wrap.o -fopenmp -L./external/stage/lib -Wl,--whole-archive -lboost_system -lboost_filesystem -lboost_thread -Wl,--no-whole-archive -lpython3.4m libsdbf.a -o swig/python/_sdbf_class.so -lcrypto -lpthread 
